...
export const pessoaJuridicaSchema = pessoaFisicaSchema.omit({ cpf: true }).extend({ tipoPessoa: z.literal('PJ') }).merge(pessoaJuridicaExtra)

export const step1Schema = z.discriminatedUnion('tipoPessoa', [pessoaFisicaSchema, pessoaJuridicaSchema])
...
export const step3Schema = z.object({
  ...
  jurosDia: z.string().optional()
}).refine(d=> !d.cobrarMulta || (!!d.valorMulta && d.valorMulta !== ''), { message:'Informe o valor da multa', path:['valorMulta'] })
  .refine(d=> !d.cobrarJuros || (!!d.jurosDia && d.jurosDia !== ''), { message:'Informe o valor do juro ao dia', path:['jurosDia'] })
